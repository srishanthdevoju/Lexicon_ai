...
export default function Shell({ children }) {
  ...
  const mainNavLinks = [
    ...
    { label: t("history", "nav"), path: "/history" },
    { label: t("notes", "nav"), path: "/notes" },
    { label: t("messages", "nav"), path: "/messages" },
    { label: t("appointments", "nav"), path: "/appointments" },
    { label: t("split", "nav"), path: "/split-view" }
  ];
