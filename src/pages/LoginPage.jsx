...
import { Scale, Lock, AtSign, ArrowRight, HelpCircle, Globe, AlertCircle, UserPlus, Briefcase, Users } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleEmailAuth = async (e) => {
    ...
    try {
      if (isSignUp) {
        await signUpWithEmail(email, password, { full_name: email.split("@")[0], role: selectedRole });
